# MasterHackTeam-SmsBomber
_It's 1Prodis to make a man go crazy_
<br><br>
...
```console
git clone https://github.com/1Prodis/smsbomber.git
cd smsbomber
...
7- Bu token'ı *discord-selfbot-1Prodis.py*'de *token* kısmına yazınız. (str olarak)<br>
...
4- Bu id'yi *discord-selfbot-1Prodis.py*'de *chat_id* kısmına yazınız. (int olarak)<br><br>
...
<br><br>
<a href="https://github.com/1Prodis" target="_blank"><img src="https://img.shields.io/badge/Github-blue?style=for-the-badge&logo=github"></a>
